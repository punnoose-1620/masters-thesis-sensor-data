...
## Paper 1: Leveraging BERT for Next-Generation Spoken Language Understanding with Joint Intent Classification and Slot Filling
...
## Paper 2: Comparative Analysis of Intent Classification in Indonesian Chatbots Using BERT and RoBERTa Models
...
## Paper 3: Intent Classification: French Recruitment Chatbot Use Case
...
## Paper 4: A New Data Augmentation Method for Intent Classification Enhancement and its Application on Spoken Conversation Datasets
...
## Paper 5: Integrating Model-Agnostic Meta-Learning with Advanced Language Embeddings for Few-Shot Intent Classification
...
## Paper 6: Enhancing LLM Function Calling with Structured Outputs
...
## Paper 7: Comparison Of Multinomial Naive Bayes Algorithm And Logistic Regression For Intent Classification In Chatbot
...
## Paper 8: Logistic Regression-Based Example Selection for Enhanced Few-Shot Learning in Intent Classification
...
## Paper 10: Fine-tuned BERT with Bi-GRU-CapsNet for Intent Prediction (intent_prediction.pdf)
...
## Paper 11: Enhancing Retrieval and Re-ranking in RAG: A Case Study on Tax Law
...
## Paper 12: Enhancing Public Access to Legal Knowledge in India: A Legal Chatbot Using Legal BERT, GPT-2, and Retrieval-Augmented Generation (RAG)
...
## Paper 13: Integrating Retrieval-Augmented Generation and Large Language Models for Financial Question Answering
...
## Paper 14: Enhancing Large Model Document Question Answering through Retrieval Augmentation
...
## Paper 15: RAGRouter: Learning to Route Queries to Multiple Retrieval-Augmented Language Models
...
## Paper 16: Retrieval Augmented Generation (RAG) using LLMs
...
## Paper 17: Retrieval-Augmented Generation (RAG) and LLM Integration
...
## Paper 18: The Research on Re-ranking Algorithm for FAQ-based Systems in the Petroleum Domain
...
## Paper 19: Comparison of Chunking Techniques Across Diverse Document Types in NLP Retrieval Tasks
...
## Paper 20: A Re-ranking Method Based on Cloud Model
...
## Paper 21: A Distributed Search Engine Based on a Re-ranking Algorithm Model
...
## Paper 22: A Sentence-Level Semantic Annotated Corpus Based on HNC Theory
...
## Paper 23: The Splitting and Matching Algorithm of Dynamic Path Oriented the Function Calling Relationship
...
|---|----------------|-----------|
| 1 | BERT Joint Intent and Slot Filling (SLU) | 0.90 |
| 2 | BERT vs. RoBERTa Intent (Indonesian Chatbot) | 0.88 |
| 3 | Intent Classification French Recruitment Chatbot | 0.88 |
| 4 | NNSI for Intent Classification (spoken) | 0.85 |
| 5 | MAML + Embeddings Few-Shot Intent | 0.85 |
| 6 | LLM Function Calling with Structured Outputs | 0.82 |
| 7 | Naive Bayes vs. Logistic Regression Intent | 0.82 |
| 8 | Logistic Regression Example Selection Few-Shot Intent | 0.82 |
| 9 | Simple Action Model, Sequential Function Calling | 0.80 |
| 10 | BERT Bi-GRU-CapsNet Intent Prediction | 0.80 |
| 11 | RAG Retrieval and Re-ranking (Tax Law) | 0.78 |
| 12 | Legal BERT, GPT-2, RAG Legal Chatbot India | 0.75 |
| 13 | Integrating RAG and LLM Financial QA | 0.75 |
| 14 | DocQA through Retrieval Augmentation (dual-path, re-ranking) | 0.72 |
| 15 | RAGRouter: Route to Multiple RAG-LLMs | 0.72 |
| 16 | RAG using LLMs (Llama, Mistral, Falcon, T5) | 0.72 |
| 17 | RAG and LLM Integration (overview) | 0.70 |
| 18 | Re-ranking for FAQ (Petroleum) | 0.70 |
|--|------------------------------Cut-Off-----------------------------|------------|
| 19 | Chunking Techniques for NLP Retrieval | 0.68 |
| 20 | Re-ranking Based on Cloud Model | 0.48 |
| 21 | Distributed Search Engine, Re-ranking (click logs) | 0.45 |
| 22 | HNC Sentence-Level Semantic Corpus | 0.42 |
| 23 | Splitting/Matching Algorithm, Function Calling (testing) | 0.25 |