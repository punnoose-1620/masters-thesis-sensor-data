...
## Paper 8: Adopting RAG for LLM-Aided Future Vehicle Design
...
## Paper 9: Explicating Tacit Regulatory Knowledge from LLMs to Auto-Formalize Requirements for Compliance Test Case Generation
...
## Paper 10: Generating Automotive Code: Large Language Models for Software Development and Verification in Safety-Critical Systems
...
## Paper 11: LADFA - A Framework of Using Large Language Models and Retrieval-Augmented Generation for Personal Data Flow Analysis in Privacy Policies
...
## Paper 12: Knowledge Management for Automobile Failure Analysis Using Graph RAG
...
## Paper 13: Measuring design compliance using neural language models – an automotive case study
...
## Paper 14: Secure Multifaceted-RAG for Enterprise: Hybrid Knowledge Retrieval with Security Filtering
...
| 8 | Adopting RAG for LLM-Aided Vehicle Design | 0.76 |
| 9 | Regulatory knowledge → test cases | 0.65 |
| 10 | Generating automotive code (LLM) | 0.50 |
| 11 | LADFA (privacy policy, RAG) | 0.68 |
| 12 | Graph RAG for failure analysis | 0.62 |
| 13 | Design compliance (NLMs) | 0.58 |
| 14 | Secure Multifaceted-RAG | 0.60 |
